...
function Home() {
  return (
    <div className="relative w-screen min-h-screen overflow-x-hidden text-white">
      ...
      <section className="relative py-28 px-6 text-center overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-200 max-w-2xl mx-auto mb-16 text-lg">
            Change does not begin with governments or corporations.
            It begins with awareness, responsibility, and everyday choices.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="group bg-gray-800/90 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-white/20 
              ...
              <p className="text-gray-200 text-sm leading-relaxed">
                Support sustainable products and reduce demand
                for industries that destroy natural ecosystems.
              </p>
            </div>
            ...
            <div className="group bg-gray-800/90 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-white/20 
              ...
              <p className="text-gray-200 text-sm leading-relaxed">
                Protect rivers, lakes, and oceans from pollution
                that damages fragile wildlife habitats.
              </p>
            </div>
            ...
            <div className="group bg-gray-800/90 backdrop-blur-lg p-8 rounded-2xl shadow-lg border border-white/20 
              ...
              <p className="text-gray-200 text-sm leading-relaxed">
                Educating others creates ripple effects that
                can influence communities and protect species.
              </p>
            </div>
      ...
      {/* FOOTER SECTION (UNCHANGED STRUCTURE) */}
