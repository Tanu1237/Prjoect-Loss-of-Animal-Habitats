  ...
  return (
    <div className="relative min-h-screen text-white overflow-x-hidden scroll-smooth">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-4 transition-all duration-1000 ease-out translate-x-0 opacity-100">
          Endangered Animals
        </h1>

        <p className="max-w-3xl text-base md:text-lg mb-6 transition-all duration-1000 delay-200 ease-out translate-x-0 opacity-100">
      ...
      <section className="px-6 md:px-12 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
          ...
          <div className="bg-green-800/70 p-6 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:-translate-y-1">
            🏞
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-14">
          ...
          {endangeredData.map((animal) => (
            <div
              ...
              className="relative rounded-xl overflow-hidden cursor-pointer h-[380px] group transition duration-500 hover:scale-[1.05] hover:shadow-2xl"
            >
...
/>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent flex flex-col justify-end p-6 transition duration-500 group-hover:from-black/90">
                ...
                <h2 className="text-3xl font-bold tracking-wide transform transition duration-500 group-hover:-translate-y-1">
                  {animal.name}
                </h2>
      ...
      <section className="px-6 md:px-12 py-16 bg-black/70">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
          ...
          <div className="bg-green-900/60 p-6 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:-translate-y-1">
            🌱
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className="bg-black/50 p-6 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-xl hover:-translate-y-1">
      ...
      {selectedAnimal && (
        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center px-4 pt-24 overflow-y-auto scroll-smooth">
